...
class SdgxbysRegistrationTests(unittest.TestCase):
    def test_source_catalog_contains_sdgxbys(self) -> None:
        source_info = get_source_info("sdgxbys")
    ...
    def test_source_scripts_contains_sdgxbys_script(self) -> None:
        script_path = SOURCE_SCRIPTS.get("sdgxbys")
